...
<head>
    ...
    <title>Blog Biodiversidad - Axolotl Team</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    ...
                    <p>
                        <h3>Ecosistemas</h3>
                        <p>Es la variedad que existe, por ejemplo, de selvas, bosques, desiertos, manglares, tundras, arrecifes, costas, lagunas, ríos, etc. </p><a href="#"><img class="img-fluid" src="assets/img/Ecosistemas.png"></a><span class="text-muted caption">Imagen de los diferentes ecosistemas en el mundo.</span>
                    ...
                    <p>Las cifras que se exponen a continuación permiten apreciar la enorme riqueza biológica de nuestro país y el gran capital biológico que poseemos:</p>
                        <li>El nuestro es el cuarto país más rico en especies de vertebrados terrestres (mamíferos, aves, reptiles y anfibios). Además, cuenta con 2,695 especies de peces, que constituyen 10% de todas las descritas en el mundo.</li><a href="#"><img class="img-fluid" src="assets/img/Variación de vertebrados.png"></a>
                        <li>En México habitan 535 especies de mamíferos, 488 terrestres, y 47 marinas, número que sólo es superado por Indonesia y Brasil, con 667 y 578, respectivamente.</li><a href="#"><img class="img-fluid" src="assets/img/Variación de especies.png"></a>
                        <li>En riqueza de aves, México ocupa el undécimo lugar mundial con 1050 especies conocidas, muchas de las cuales son endémicas. Esto hace de nuestro país un importante centro de evolución y diversificación.</li>
